...
export class Backend implements backendInterface {
    ...
    async adminCreateProduct(arg0: Product): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminCreateProduct(to_candid_Product_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminSetProductPublishStatus(arg0: ProductId, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminSetProductPublishStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrder(arg0: Array<OrderItem>): Promise<OrderId> {
        if (this.processError) {
            try {
    ...
    async initializeShop(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeShop();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "electronics" in value ? Category.electronics : "homeDecor" in value ? Category.homeDecor : value;
}
